...
export const commonDict = {
  ru: {
    ...
    ver_title: 'Версия приложения', ver_dev: 'в разработке',
    ver_update: 'Обновить', ver_checking: 'Проверяю…',
    ver_hint: 'Обновления приходят сами при открытии приложения. Кнопка нужна, если изменения не появились.',
  ...
  es: {
    ...
    ver_title: 'Versión de la app', ver_dev: 'en desarrollo',
    ver_update: 'Actualizar', ver_checking: 'Comprobando…',
    ver_hint: 'Las actualizaciones llegan solas al abrir la app. El botón es por si no aparecen.',
  ...
  en: {
    ...
    ver_title: 'App version', ver_dev: 'development',
    ver_update: 'Update', ver_checking: 'Checking…',
    ver_hint: 'Updates arrive on their own when the app opens. The button is for when they do not.',
